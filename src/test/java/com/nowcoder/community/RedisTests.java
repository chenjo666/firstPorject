...
public class RedisTests {
    ...
    public void testSortedSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "唐三", 10);
        redisTemplate.opsForZSet().add(redisKey, "十号", 100);
        redisTemplate.opsForZSet().add(redisKey, "叶凡", 90);

        System.out.println(redisTemplate.opsForZSet().zCard(redisKey));
        System.out.println(redisTemplate.opsForZSet().score(redisKey, "唐三"));
        System.out.println(redisTemplate.opsForZSet().reverseRank(redisKey, "十号"));
    ...
    public void testTransactional() {
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations operations) throws DataAccessException {
                ...
                operations.opsForSet().add(redisKey, "chen");
